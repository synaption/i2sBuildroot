...
git clone https://github.com/cdsteinkuehler/pi
...
make -C buildroot/ BR2_EXTERNAL=../pi O=../output raspberrypicm4io-64-rauc_defconfig

# ...or for the Raspberry Pi 4B:
make -C buildroot/ BR2_EXTERNAL=../pi O=../output raspberrypi4-64-rauc_defconfig
...
cd ~/MyWorkDir
make -C buildroot/ BR2_EXTERNAL=../pi O=../rescue raspberrypicm4io-64-rauc_defconfig
...
For quick experiments, you may wish to modify the pi tree directly, or a
...
cd MyCoolProject
make -C buildroot/ BR2_EXTERNAL=../pi:../MyApp1:../MyApp2 O=../output ...
```
...
squashfs version of the existing pi ext4 rootfs.  For production usage, you
...
attempting to build the pi Buildroot project.
...
* [Raspberry Pi 4 Boot Details](https://www.raspberrypi.com/documentation/computers/raspberry-pi.html#raspberry-br2rauc-4-boot-eeprom)
